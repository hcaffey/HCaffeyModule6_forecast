const apiKey = "5e9006212c7c91c4810bbcea2d7a87e4";
...
function getWeather(event) {
    ...
    if (historyVar < 6) {
        ...
        let currentWeather = "https://api.openweathermap.org/data/2.5/weather?q=" + citySearchVal + "&appid=5e9006212c7c91c4810bbcea2d7a87e4&units=Imperial";
        ...
        let getWeather = "https://api.openweathermap.org/data/2.5/forecast?q=" + citySearchVal + "&appid=5e9006212c7c91c4810bbcea2d7a87e4&units=Imperial";
        ...
        fetch(getWeather)
            ...
            }) // indices based on openweather's return data
            .then(data => {
